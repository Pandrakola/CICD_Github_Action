...
# Load Data
dataset = pd.read_csv(r'C:\Anitha\DataScience-Vscode\CICD\code_2(iris.csv)\iris.csv')
...
#C:\Anitha\DataScience-Vscode\CICD\code_2(iris.csv)>pip install requirements.txt
